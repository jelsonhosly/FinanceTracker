...
export default function Accounts() {
  ...
  const mainCurrency = currencies.find(c => c.code === mainCurrencyCode); // Find the main currency object
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          >
            <BlurView intensity={20} tint="light" style={styles.blurOverlay}>
              ...
              <Text style={styles.balanceAmount}>{mainCurrency?.symbol}{totalBalance.toFixed(2)}</Text>
          ...
          {/* Bottom spacer to prevent navigation bar overlap */}
