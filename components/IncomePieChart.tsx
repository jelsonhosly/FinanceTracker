...
export function IncomePieChart({ month, year, account, category }: IncomePieChartProps) {
  ...
  const demoData = [
    { name: 'Salary', amount: 2000, color: '#30D158' },
    { name: 'Freelance', amount: 450, color: '#5E5CE6' },
    { name: 'Investments', amount: 320, color: '#FF9F0A' },
